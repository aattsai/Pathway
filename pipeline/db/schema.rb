...
ActiveRecord::Schema.define(version: 20160229193000) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "pathway_donors", force: :cascade do |t|
  ...
  create_table "pathway_projects", force: :cascade do |t|
    t.integer  "project_id",     null: false
    t.integer  "pathway_id",     null: false
    t.integer  "donated_weight", null: false
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
  end
